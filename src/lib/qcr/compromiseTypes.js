// Reference catalog of 20 widely-recognized cyber compromise types, plus a
...
export const COMPROMISE_TYPES = [
  {
    ...
    keywords: ['business email', 'bec', 'email compromise', 'ceo fraud', 'invoice fraud', 'vendor email', 'wire fraud', 'wire transfer fraud'],
  ...
  },
  {
    ...
    keywords: ['credential theft', 'credential stuffing', 'account takeover', 'stolen credentials', 'brute force', 'password spray', 'login attack'],
  ...
  },
  {
    id: 'insider-threat',
    name: 'Insider Threat',
    keywords: ['insider', 'disgruntled', 'employee theft', 'privilege abuse', 'rogue employee', 'malicious insider'],
  ...
  },
  {
    ...
    keywords: ['ddos', 'denial of service', 'dos attack', 'botnet flood', 'volumetric', 'service outage attack'],
  ...
  },
  {
    ...
    keywords: ['data breach', 'exfiltration', 'data theft', 'data leak', 'pii exposure', 'database dump', 'records exposed'],
  ...
  },
  {
    ...
    keywords: ['supply chain', 'software supply', 'dependency', 'compromised update', 'poisoned package', 'build system'],
  ...
  },
  {
    ...
    keywords: ['malware', 'trojan', 'virus', 'worm', 'spyware', 'rootkit', 'backdoor', 'infostealer'],
  ...
  },
  {
    ...
    keywords: ['sql injection', 'sqli', 'xss', 'cross-site', 'web application', 'api abuse', 'injection attack', 'owasp'],
  ...
  },
  {
    ...
    keywords: ['cloud misconfig', 's3 bucket', 'exposed storage', 'misconfiguration', 'open bucket', 'iam misconfig', 'public bucket'],
  ...
  },
  {
    ...
    keywords: ['payment fraud', 'wire transfer', 'financial fraud', 'fraudulent payment', 'ach fraud', 'card fraud', 'invoice manipulation'],
  ...
  },
  {
    ...
    keywords: ['third-party breach', 'third party breach', 'vendor breach', 'partner breach', 'service provider', 'outsourced breach'],
